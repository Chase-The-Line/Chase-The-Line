...
export const heroTwo = {
  ...
  inverse: false,
  topLine: {
    text: "Vous êtes en panne ? Pas de panique.",
  },
...
export const heroThree = {
  ...
  headline: "Location",
  description:
    "Equipés de nos VTT à assistance éléctrique vous allez pouvoir découvrir les sentiers les plus mythiques de notre région à partir d'une demi journée jusqu'à plusieurs jours.",
  buttonLabel3: "Voir plus",
  link: "https://chasetheline.fr/#/location",
  imgStart: "start",
